...
export const BUILTIN_SNIPPETS: Snippet[] = [
  ...
  { name: 'create', prefix: 'create', description: 'Declare a variable', body: 'create ${1:name} = ${2:value}$0', languages: ZX },
  {
    name: 'database',
    prefix: 'database',
    description: 'Database connection block',
    body: 'database ${1:Name}\n\tprovider ${2|sqlite,postgres,memory|}\n\tconnection "${3:connection_string}"\nend\n$0',
    languages: ZX,
  },
  {
    name: 'table',
    prefix: 'table',
    description: 'Database table declaration',
    body: 'table ${1:Name}\n\thas ${2:field} as ${3|text,whole,number,truth|}\nend\n$0',
    languages: ZX,
  },
  {
    name: 'try-catch',
  ...
  },
  {
    ...
    body: 'import ${1:ModuleName} as ${2:Alias}$0',
    languages: ZX,
  },
  {
    name: 'import-showing',
    prefix: 'importshowing',
    description: 'Import selected symbols from a module',
    body: 'import ${1:ModuleName} showing ${2:symbol1}, ${3:symbol2}$0',
    languages: ZX,
  },
  {
    name: 'test',
